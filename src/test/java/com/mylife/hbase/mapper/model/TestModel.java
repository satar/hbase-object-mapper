...
public class TestModel {
    ...
    public TestModel(Long longField, String stringField, Boolean booleanField, byte[] byteArrayField,
    ...
    public String toString() {
        ...
        builder.append("TestModel [longField=").append(longField).append(", stringField=").append(stringField)
                .append(", booleanField=").append(booleanField).append(", byteArrayField=")
                .append(Arrays.toString(byteArrayField)).append(", contentTypeField=").append(contentTypeField)
                .append(", badMap=").append(badMap).append(", notAMap=").append(notAMap).append("]");
