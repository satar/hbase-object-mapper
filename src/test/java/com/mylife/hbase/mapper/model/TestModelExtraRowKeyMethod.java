...
/**
 * A test POJO with extra @HBaseRowKey on two methods
 * 
 * @author Mike E
 */
@HBasePersistance(tableName = "TEST_MODEL", defaultColumnFamilyName = "STUFF")
public class TestModelExtraRowKeyMethod {
    ...
    public TestModelExtraRowKeyMethod(Long longField, String stringField, Boolean booleanField, byte[] byteArrayField,
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TestModelExtraRowKeyMethod other = (TestModelExtraRowKeyMethod) obj;
